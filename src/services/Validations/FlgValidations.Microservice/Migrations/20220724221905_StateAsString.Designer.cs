...
namespace FlgValidation.Microservice.Migrations
{
    ...
    [Migration("20220724221905_StateAsString")]
    partial class StateAsString
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlgValidations.Microservice.Domain.Study", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FlgValidations.Microservice.Domain.StudySeries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FlgValidations.Microservice.Domain.StudySeriesInstance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FlgValidations.Microservice.Domain.StudySeries", b =>
                {
                    b.HasOne("FlgValidations.Microservice.Domain.Study", null)
                        .WithMany("Series")
                        .HasForeignKey("StudyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_study_series_studies_study_id");

                    b.OwnsOne("FlgValidations.Microservice.Domain.Thickness", "Thickness", b1 =>
                        {
            ...
            modelBuilder.Entity("FlgValidations.Microservice.Domain.StudySeriesInstance", b =>
                {
                    b.HasOne("FlgValidations.Microservice.Domain.StudySeries", null)
