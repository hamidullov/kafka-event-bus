...
namespace FlgStudies.Microservice.Migrations
{
    ...
    [Migration("20220724221303_AddedStateHistoryStateToString")]
    partial class AddedStateHistoryStateToString
    {
            ...
            modelBuilder.Entity("FlgStudies.Microservice.Domain.StudyStateHistory", b =>
                {
                    ...
                    b.HasIndex("StudyId")
                        .HasDatabaseName("ix_study_state_history_study_id");
            ...
            modelBuilder.Entity("FlgStudies.Microservice.Domain.StudyStateHistory", b =>
                {
                    b.HasOne("FlgStudies.Microservice.Domain.Study", null)
                        ...
                        .HasForeignKey("StudyId")
                        .HasConstraintName("fk_study_state_history_studies_study_id");
                });
